...
class InvoiceMainPaxPaymentRepository extends AppRepository
{
	protected $model;
	...
	public function filter()
	{
		...
		// }
		 ...
		 // Filter by balance_status_pax
			if ($request->filled('balance_status_pax')) {
				$balanceStatus = (int) $request->balance_status_pax;
