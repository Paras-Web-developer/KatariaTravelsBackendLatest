                        ...
                        <td style="font-size: 11px;">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr style="">
                                    <td style="padding:2px;border:1px solid #ccc;">Payment Method</td>
                                    <td colspan="4" style="padding:2px;border:1px solid #ccc;text-align:right;">
                                         {{ $invoiceMain->airticket && $invoiceMain->airticket['airticket_from_pax'] && isset($invoiceMain->airticket['airticket_from_pax']['transation_type_id']) ? $invoiceMain->airticket['airticket_from_pax']['transation_type_id'] : '' }}
                                    </td>
                                </tr>
